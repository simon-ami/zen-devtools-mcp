#!/usr/bin/env node
/**
 * Builds the zen-devtools-mcp .mcpb bundle (Claude Desktop extension).
...
const stagingDir = mkdtempSync(resolve(tmpdir(), 'zen-devtools-mcpb-'));
...
try {
  ...
  const outFile = resolve(outDir, `zen-devtools-mcp-${pkg.version}.mcpb`);
